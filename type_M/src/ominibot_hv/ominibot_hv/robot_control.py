...
class Ominibot_Robot(Node):
    ...
    def update_robot_state(self):
        ...
        if checkCmd == 1:
            ...
            imu_qz = int.from_bytes(imu_val[12:14], byteorder='big', signed=True)/1000
            imu_qw = int.from_bytes(imu_val[14:16], byteorder='big', signed=True)/1000
            imu_qx = int.from_bytes(imu_val[16:18], byteorder='big', signed=True)/1000
            imu_qy = int.from_bytes(imu_val[18:], byteorder='big', signed=True)/1000
