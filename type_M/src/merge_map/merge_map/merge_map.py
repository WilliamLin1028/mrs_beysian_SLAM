...
class MergeMapNode(Node):
    def __init__(self):
        ...
        self.publisher = self.create_publisher(OccupancyGrid, '/merge_map', qos)
        ...
        self.subscription = self.create_subscription(OccupancyGrid, '/map', self.map1_callback, 10)
        self.subscription = self.create_subscription(OccupancyGrid, '/robotB/map', self.map2_callback, 10)
        self.map1 = None
        self.map2 = None
